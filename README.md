...
### Senior Data Engineer · AI Agents · Azure · Snowflake · Databricks · Healthcare Data Platforms
...
![Visitors](https://visitor-badge.laobi.icu/badge?page_id=Kaushal21394.Kaushal21394)
...
I design multi-source agents that pull from structured databases (Snowflake Intelligence), live web sources, and unstructured documents (PDFs, reports) — then surface insights through self-service Streamlit interfaces built for non-technical users. At Syneos Health, these agents power decisions across pharmaceutical campaign strategy, physician targeting, and clinical analytics.

**Data Platform Engineering**
End-to-end pipeline architecture on Azure (ADF, Databricks) and AWS (Glue, S3), with Snowflake as the core analytical layer. I specialise in building reusable, templated orchestration frameworks that scale across multiple client engagements — not just one-off pipelines.

**DataOps & CI/CD**
Automated deployment pipelines in Azure DevOps, DBT transformation layers with version-controlled models, and workflow governance standards introduced across globally distributed engineering teams.

**HIPAA-Compliant Infrastructure**
Cloud-native architectures processing millions of regulated records daily. I've designed and maintained systems where compliance is a first-class engineering concern — not an afterthought.
...
| Snowflake | ⭐⭐⭐⭐⭐ | Architecture, performance tuning, Snowflake Intelligence |
| Python (Data/API) | ⭐⭐⭐⭐⭐ | ETL, REST APIs, ML pipelines, agents |
| DBT | ⭐⭐⭐⭐⭐ | Claims data modelling, versioned layers, team standards |
| LangChain / RAG | ⭐⭐⭐⭐☆ | Production AI agents, custom retrieval pipelines |
| Databricks / Spark | ⭐⭐⭐⭐☆ | Large-scale transformations, HIPAA data |
| Azure DevOps CI/CD | ⭐⭐⭐⭐☆ | Full build/test/deploy automation, Azure Web Apps |
| AWS (Glue, S3, EC2) | ⭐⭐⭐⭐☆ | Data lake design, IAM, NGS pipeline deployment |
| Streamlit | ⭐⭐⭐⭐☆ | Self-service AI interfaces for non-technical users |
| React / Full-stack | ⭐⭐⭐☆☆ | UI wireframing + implementation in platform builds |
...
```
Syneos Health (2021 – Present)
├── Senior Data Engineer        Jul 2023 – Present   Toronto, ON / Boston, MA
│   ├── AI Agents (RAG · GPT-4 · Snowflake Intelligence · Streamlit)
│   ├── HIPAA-compliant architectures (Azure · Snowflake · Databricks)
│   ├── CI/CD pipelines & workflow governance across global teams
│   └── Technical lead & mentor for 3+ junior engineers
│
└── Data Engineer II            Sep 2021 – Jul 2023   Boston, MA
    ├── Full-stack platform (Python APIs · React · Azure DevOps · Azure Web Apps)
    ├── DBT transformation layers for large-scale healthcare claims data
    ├── Proprietary media campaign platform for pharma commercialization
    └── Physician targeting models → 55% lift in engagement

Genocea Biosciences (2019 – 2021)
├── Data Engineer               Jan 2020 – Sep 2021
│   ├── AWS Data Lake → 30% reduction in data management costs
│   └── NGS pipeline + LIMS for clinical trials
│
└── Data Engineer Co-op         Jan 2019 – Dec 2019
    └── Django self-service app · Lab automation · NGS optimization
```
...
- **M.S. Information Systems** — Northeastern University, Boston, MA *(2017–2019)*
- **B.E. Instrumentation Engineering** — Mumbai University, India *(2012–2016)*

---

## 📬 Let's Connect

I'm always open to discussing data engineering, AI systems, healthcare data challenges, or just talking shop about the modern data stack.
...
<p align="center"><i>This README is a living document — updated as new projects ship.</i></p>
